...
public class ButtonShader extends GVRShader{
    ...
    public ButtonShader(GVRContext gvrContext) {
        ...
        super("float textureSwitch", "sampler2D state1Background sampler2D state1Text sampler2D state2Background sampler2D state2Text sampler2D state3Background sampler2D state3Text", "");
